...
const FilterGroup = styled.div`
  ...
  border: 1px solid #ccc; /* Added border for model and year dropdowns */
  border-radius: 5px; /* Added border radius for model and year dropdowns */
  padding: 5px; /* Added padding for model and year dropdowns */
  margin-bottom: 10px; /* Added margin for spacing between filter groups */
`;
...
const Button = styled.button`
  ...
  border-radius: 5px;
  cursor: pointer;
  margin-left: auto; /* Aligned button to the right */
