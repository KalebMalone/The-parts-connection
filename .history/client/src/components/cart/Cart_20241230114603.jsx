  ...
  const handleCheckout = async () => {
    ...
    const orderData = {
      items: cartItems.map((item) => ({
        product_id: item.id, // Correct field name for product ID
        quantity: item.quantity, // Ensure this field exists in the item object
        price: item.price, // Ensure this is a valid price field
        product_name: item.name, // Ensure this is the correct field for the product's name
      })),
