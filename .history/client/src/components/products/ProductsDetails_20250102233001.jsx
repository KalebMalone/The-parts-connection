...
function ProductDetails() {
  ...
  const [imageError, setImageError] = useState(false); // Fix the state hook
      ...
      <ProductContentWrapper>
        <ProductImage 
          ...
          onLoad={() => { 
            ...
            setImageError(false); // Corrected usage of setImageError
          }}
          onError={() => { 
            imageRef.current.classList.add('error'); 
            setImageError(true); // Corrected usage of setImageError
