...
const Profile = () => {
  ...
  const handleDeleteProfile = async () => {
    try {
      ...
      // Clear any session data in the client
      sessionStorage.clear(); // Clear sessionStorage
      localStorage.clear(); // Clear localStorage
      document.cookie = "session=; expires=Thu, 01 Jan 1970 00:00:00 UTC"; // Remove session cookie
  
      alert("Profile deleted successfully!");
  
      // Redirect to the main page (Home page)
      window.location.href = "/"; // Redirect to the home page or main page
