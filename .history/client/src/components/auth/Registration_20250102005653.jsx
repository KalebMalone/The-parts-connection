...
// In the onSubmit function, change this part:
if (response.ok) {
  if (data.name) { // Check if 'name' is present directly in the response
    toast.success(
      isLogin
        ? `Welcome back, ${data.name}!`
        : `Welcome, ${data.name}!`
    );
    updateUser(data); // Use the entire data object here
