        ...
        <Container>
            ...
            <Formik
                ...
                onSubmit={async (values) => {
                    // Check if values is properly initialized and all required fields are present
                    ...
                    <StyledForm onSubmit={handleSubmit}>
                        {!isLogin && (
                            <FormField>
                                ...
                                <input
                                    ...
                                    onBlur={handleBlur}
                                    value={values.name || ""} {/* Default value to empty string if undefined */}
                                />
                        ...
                        <FormField>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                onBlur={handleBlur}
                                value={values.email || ""} {/* Default value to empty string if undefined */}
                            />
                        ...
                        <FormField>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                onBlur={handleBlur}
                                value={values.password || ""} {/* Default value to empty string if undefined */}
                            />
