...
from werkzeug.security import check_password_hash  # Use this to check hashed passwords
    ...
    def post(self):
        try:
            ...
            if user:
                ...
                if check_password_hash(user.password, password):  # Ensure passwords match
